...
<%-- 상대 경로 방식으로 주소 작성 --%>
  ...
  <div>부서코드(DEPT_ID) : <input type = "text" name="deptId"></div>
  <div>부서이름(DEPT_TITLE) : <input type = "text" name="deptTitle"></div>
  <div>지역코드(LOCATION_ID) : <input type = "text" name="locationId"></div>
